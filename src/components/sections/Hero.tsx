...
export function Hero() {
  return (
    <section className="relative overflow-hidden pb-[clamp(3.5rem,2rem+4vw,6rem)] pt-[clamp(3rem,1.5rem+5vw,6rem)]">
      ...
      <div className="container-site">
        ...
        {/* Fakten-Zeile: typografisch, durch Haarlinien getrennt. */}
        <dl className="mt-12 grid border-t border-line sm:grid-cols-3 sm:divide-x sm:divide-line">
          {heroFacts.map((f, i) => (
            <div
              key={f.k}
      ...
      {/* Bildband: natürliches Seitenverhältnis des Originalfotos, mobil
          stärker beschnitten, damit es nicht zum Streifen zusammenfällt. */}
      <div className="container-site mt-[clamp(2.5rem,1.5rem+3vw,4rem)]">
        <figure className="relative" data-reveal>
          ...
          <figcaption className="mt-5 grid gap-x-10 gap-y-4 border-t border-line pt-5 lg:grid-cols-12">
            <p className="text-[0.9375rem] leading-relaxed text-ink lg:col-span-7">
              <span className="mr-3 inline-block h-[2px] w-9 -translate-y-[0.3em] bg-magenta align-middle" aria-hidden="true" />
