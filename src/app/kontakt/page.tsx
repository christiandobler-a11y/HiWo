...
export default function KontaktPage() {
  return (
    <>
      {/* Titel und Einleitung nebeneinander (statt gestapelt in einer
          schmalen Spalte) -- so füllt der Lead-Text schon im Kopf einen Teil
          der rechten Seite, bevor darunter das Schild-Foto folgt. Gestapelt
          blieb die komplette rechte Hälfte bis zur Anschrift leer. */}
      <PageHeader
        label="Kontakt"
        title={<>Ein Anruf reicht.</>}
        lead="Montag bis Donnerstag 8 bis 17 Uhr, freitags 8 bis 15 Uhr geht bei uns direkt jemand ans Telefon – ohne Auswahlmenü, ohne Rückrufversprechen."
      />
